...
export default function OffplanPage() {
  ...
  const offplanRef = useRef<HTMLDivElement | null>(null);
  ...
  const scrollToNext = () => {
    if (offplanRef.current) {
      const yOffset = -50;
      const y =
        offplanRef.current.getBoundingClientRect().top +
        window.scrollY +
        yOffset;
  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      ...
      <div className="relative h-[70vh] bg-black text-white flex items-center justify-center">
        ...
        >
          ...
          <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
            Explore exclusive off-plan properties with flexible payment plans
      ...
      {/* Property List */}
      <div ref={offplanRef} className="py-12">
        {loading ? (
              ...
              {paginatedProperties.map((p) => (
                ...
                >
                  ...
                  <div className="p-4 bg-[var(--bg-color)]">
                    ...
                    <a
                      href={`/offplan-properties/${p.slug}`}
