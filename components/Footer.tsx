...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-[var(--color5)] via-[var(--color1)] to-[var(--color3)] text-white px-6 py-10 md:px-16 lg:px-24">
      <div className="flex flex-col lg:flex-row lg:justify-between gap-10">
        ...
        <div className="flex-1">
          <Image
            ...
            height={50}
          />
          <p className="text-sm leading-relaxed text-gray-700 text-justify mt-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex space-x-4 mt-4">
            ...
            >
              <Facebook className="w-6 h-6 text-blue-500 hover:text-[#4267B2]" />
            </Link>
            <Link
              ...
              rel="noopener noreferrer"
            >
              <Instagram className="w-6 h-6 text-pink-500 hover:text-[#C13584]" />
            </Link>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-col sm:flex-row">
              <input
                ...
                className="px-3 py-2 bg-transparent text-black text-sm flex-grow mb-2 sm:mb-0 sm:mr-2 border border-gray-500 rounded-md placeholder-gray-400 focus:outline-none focus:border-[var(--primary-color)]"
              />
              <button
      ...
      <div className="border-t border-gray-700 mt-10 pt-4 flex flex-col sm:flex-row justify-between items-center text-gray-400 text-sm">
        ...
        <p className="text-center sm:text-left text-gray-700">
          ...
          <span className=" font-medium">Khalsa Property Dealers</span>. All
          rights reserved.
        </p>
        ...
        <div className="flex items-center gap-4 mt-2 sm:mt-0">
          <Link
            href="/terms"
            className="hover:text-[var(--primary-color)] transition-colors text-gray-700"
          >
            Terms & Conditions
          </Link>
          <span>|</span>
        ...
        {/* Right: Bigwig Media */}
        <div className="mt-2 sm:mt-0 text-center sm:text-right text-gray-700">
          Made & Marketed by{" "}
          <Link
